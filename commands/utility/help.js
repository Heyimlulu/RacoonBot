    ...
    execute(message) {
        ...
        if (message.content.startsWith(`${config.prefix}help codeblock`)){
            helpCommandEmbed.setTitle(help.general.codeblock.name)
                ...
                .addField('Example', help.general.codeblock.example)
                .addField('Languages', `\u0060${help.general.codeblock.language}\u0060`)
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            .addField('📝\u2000General commands', `\u0060${help.general["8ball"].name} \u0060 \u0060${help.general.advice.name}\u0060 \u0060${help.general.codeblock.name}\u0060 \u0060${help.general.fact.name}\u0060 \u0060${help.general.flip.name}\u0060 \u0060${help.general.roll.name}\u0060  \u0060${help.general.sayd.name}\u0060`, false) // General commands
