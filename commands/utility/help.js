...
module.exports = {
    ...
    execute(message) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            .addField('📝\u2000General commands', `\u0060${help.general["8ball"].name} \u0060 \u0060${help.general.advice.name}\u0060 \u0060${help.general.fact.name}\u0060 \u0060${help.general.flip.name}\u0060 \u0060${help.general.roll.name}\u0060  \u0060${help.general.sayd.name}\u0060`, false) // General commands
